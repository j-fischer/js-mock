...
describe('JsMock', function(){
  ...
  describe('mock', function(){
    ...
    it("each mock instance is unique", function () {
      ...
      expectExpectationError(myFunc1.verify, 'ExpectationError: Missing invocations for myFunc():\n>>> Expectation for call 1 with args undefined, will return undefined');
      expectExpectationError(myFunc2.verify, 'ExpectationError: Missing invocations for myFunc():\n>>> Expectation for call 1 with args undefined, will return undefined');
    ...
    it("should throw if some property expectations are not fulfilled", function () {
      ...
      expectExpectationError(mock.func1.verify, 'ExpectationError: Missing invocations for MyObject.func1():\n>>> Expectation for call 1 with args undefined, will return undefined');
    ...
    it("should mock function with properties, such as jQuery", function () {
      ...
      expectExpectationError(jqueryMock.verify, 'ExpectationError: Missing invocations for $():\n>>> Expectation for call 1 with args ["div"], will return "foo"');
      expectExpectationError(jqueryMock.extend.verify, 'ExpectationError: Missing invocations for $.extend():\n>>> Expectation for call 1 with args [{"a":1},{"foo":"bar"}], will return {"a":1}');
